...
const ExperienceCard = ({ exp }: { exp: Experience }) => {
    return (
        <div
            className="relative bg-[#0f0f25]/80 border border-cyan-800/30 rounded-2xl p-6 shadow-lg hover:shadow-cyan-500/20 transition duration-300 group"
        >
            {/* Top Gradient Bar */}
            ...
            <div className="flex justify-between items-center mb-5">
                <span className="text-blue-400 text-lg font-medium">{exp?.company}</span>
                <span className="text-sm bg-[#1b1b3a] text-gray-300 px-3 py-1 rounded-full">
